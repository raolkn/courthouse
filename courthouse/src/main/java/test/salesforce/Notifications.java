 ...
 *         &lt;element name="Notification" type="{http://soap.sforce.com/2005/09/outbound}ContactNotification" maxOccurs="100"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class Notifications {
    ...
    protected List<ContactNotification> notification;
     ...
     * {@link ContactNotification }
     * 
     * 
     */
    public List<ContactNotification> getNotification() {
        if (notification == null) {
            notification = new ArrayList<ContactNotification>();
        }
     ...
     *     
     */
    public void setNotification(List<ContactNotification> notification) {
